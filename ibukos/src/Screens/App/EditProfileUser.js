...
class EditProfileUser extends Component {
  ...
  handleSave = async () => {
    ...
    await this.props
      .dispatch(updateUser(formData.id, formDataUser))
      .then(res => {
        ToastAndroid.show(
    ...
    return (
      <Container>
        <View style={styles.img}>
          ...
          />
          <Text
            style={{color: '#3498db', marginTop: 5}}
          ...
          <View style={styles.buttonWrap}>
            {this.props.user.isLoading ? (
              <Button
                ...
                disabled>
                <Spinner color="white" style={styles.loading} />
                <Text style={styles.textBtnLoading}> SAVE </Text>
              </Button>
            ) : (
